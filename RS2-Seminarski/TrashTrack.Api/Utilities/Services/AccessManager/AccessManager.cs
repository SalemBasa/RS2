...
namespace TrashTrack.Api
{
	public class AccessManager : IAccessManager
	{
		...
		public AccessManager(IMapper mapper, ICryptoService cryptoService, IUsersService usersService, IOptions<JwtTokenConfig> jwtTokenConfig, IPhotosService PhotosService)
		{
			_mapper = mapper;
		...
		{
			var user = _mapper.Map<UserUpsertDto>(model);
