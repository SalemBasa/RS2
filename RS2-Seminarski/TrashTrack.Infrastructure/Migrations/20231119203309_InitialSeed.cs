        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GarbageType = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Photo = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    GarbageId = table.Column<int>(type: "int", nullable: true),
                    PhotoId = table.Column<int>(type: "int", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Reports_Garbages_GarbageId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Rewards_Quizzes_QuizId",
                        column: x => x.QuizId,
                        principalTable: "Quizzes",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ScheduleDrivers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ScheduleDrivers_Schedules_ScheduleId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ScheduleGarbages", x => x.Id);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ScheduleGarbages_Schedules_ScheduleId",
                        column: x => x.ScheduleId,
                        principalTable: "Schedules",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2023, 2, 1, 0, 0, 0, 0, DateTimeKind.Local), "Regular trash collection service", null, "Trash Collection", 20.00m },
                    { 2, new DateTime(2023, 2, 1, 0, 0, 0, 0, DateTimeKind.Local), "Service for recycling pickup", null, "Recycling Pickup", 15.50m },
                    { 3, new DateTime(2023, 2, 1, 0, 0, 0, 0, DateTimeKind.Local), "Disposal service for green waste", null, "Green Waste Disposal", 12.75m },
                    { 4, new DateTime(2023, 2, 1, 0, 0, 0, 0, DateTimeKind.Local), "Removal service for bulky items", null, "Bulk Item Removal", 30.00m },
                    { 5, new DateTime(2023, 2, 1, 0, 0, 0, 0, DateTimeKind.Local), "Specialized service for hazardous waste", null, "Hazardous Waste Pickup", 25.50m }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 0m, null, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2023, 2, 1, 0, 0, 0, 0, DateTimeKind.Local), "site.admin@trashtrack.com", "Site", 0, true, true, "Admin", null, null, "b4I5yA4Mp+0Pg1C3EsKU17sS13eDExGtBjjI07Vh/JM=", "1wQEjdSFeZttx6dlvEDjOg==", "38761123456", null, null, 0 },
                    { 2, 0m, null, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2023, 2, 1, 0, 0, 0, 0, DateTimeKind.Local), "site.driver@trashtrack.com", "Site", 0, true, true, "Driver", null, null, "b4I5yA4Mp+0Pg1C3EsKU17sS13eDExGtBjjI07Vh/JM=", "1wQEjdSFeZttx6dlvEDjOg==", "38761123456", null, null, 2 },
                    { 3, 0m, null, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2023, 2, 1, 0, 0, 0, 0, DateTimeKind.Local), "site.user@trashtrack.com", "Site", 0, true, true, "User", null, null, "b4I5yA4Mp+0Pg1C3EsKU17sS13eDExGtBjjI07Vh/JM=", "1wQEjdSFeZttx6dlvEDjOg==", "38761123456", null, null, 1 }
                });

            migrationBuilder.InsertData(
                table: "VehicleModels",
                columns: new[] { "Id", "CreatedAt", "ModifiedAt", "Name", "VehicleType" },
                values: new object[,]
                {
                    { 1, new DateTime(2023, 2, 1, 0, 0, 0, 0, DateTimeKind.Local), null, "Truck 1", 0 },
                    { 2, new DateTime(2023, 2, 1, 0, 0, 0, 0, DateTimeKind.Local), null, "Truck 2", 0 },
                    { 3, new DateTime(2023, 2, 1, 0, 0, 0, 0, DateTimeKind.Local), null, "Truck 3", 0 },
                    { 4, new DateTime(2023, 2, 1, 0, 0, 0, 0, DateTimeKind.Local), null, "Garbage Truck 1", 1 },
                    { 5, new DateTime(2023, 2, 1, 0, 0, 0, 0, DateTimeKind.Local), null, "Garbage Truck 2", 1 },
                    { 6, new DateTime(2023, 2, 1, 0, 0, 0, 0, DateTimeKind.Local), null, "Garbage Truck 3", 1 }
                });
            ...
            migrationBuilder.InsertData(
                table: "Orders",
                columns: new[] { "Id", "CreatedAt", "IsDeleted", "ModifiedAt", "OrderDate", "OrderNumber", "Total", "UserId", "isCanceled" },
                values: new object[,]
                {
                    { 1, new DateTime(2023, 2, 1, 0, 0, 0, 0, DateTimeKind.Local), false, null, new DateTime(2023, 11, 19, 21, 33, 8, 474, DateTimeKind.Local).AddTicks(505), "ORD1001", 65.50m, 1, false },
                    { 2, new DateTime(2023, 2, 1, 0, 0, 0, 0, DateTimeKind.Local), false, null, new DateTime(2023, 11, 17, 21, 33, 8, 474, DateTimeKind.Local).AddTicks(520), "ORD1002", 15.00m, 2, false },
                    { 3, new DateTime(2023, 2, 1, 0, 0, 0, 0, DateTimeKind.Local), false, null, new DateTime(2023, 11, 14, 21, 33, 8, 474, DateTimeKind.Local).AddTicks(527), "ORD1003", 40.25m, 3, false },
                    { 4, new DateTime(2023, 2, 1, 0, 0, 0, 0, DateTimeKind.Local), false, null, new DateTime(2023, 11, 12, 21, 33, 8, 474, DateTimeKind.Local).AddTicks(535), "ORD1004", 20.50m, 1, false },
                    { 5, new DateTime(2023, 2, 1, 0, 0, 0, 0, DateTimeKind.Local), false, null, new DateTime(2023, 11, 9, 21, 33, 8, 474, DateTimeKind.Local).AddTicks(551), "ORD1005", 35.75m, 2, false }
                });

            migrationBuilder.InsertData(
                table: "Questions",
                columns: new[] { "Id", "Content", "CreatedAt", "ModifiedAt", "Points", "QuizId" },
                values: new object[,]
                {
                    { 1, "What is the first step in the recycling process?", new DateTime(2023, 2, 1, 0, 0, 0, 0, DateTimeKind.Local), null, 10, 1 },
                    { 2, "What is a common practice to reduce plastic waste?", new DateTime(2023, 2, 1, 0, 0, 0, 0, DateTimeKind.Local), null, 10, 2 },
                    { 6, "Which of the following is a renewable energy source?", new DateTime(2023, 2, 1, 0, 0, 0, 0, DateTimeKind.Local), null, 12, 5 }
                });

            migrationBuilder.InsertData(
                table: "Reports",
                columns: new[] { "Id", "CreatedAt", "GarbageId", "ModifiedAt", "Note", "Photo", "PhotoId", "ReportState", "ReportType", "ReporterUserId" },
                values: new object[,]
                {
                    { 1, new DateTime(2023, 2, 1, 0, 0, 0, 0, DateTimeKind.Local), 1, null, "Trash overflow near park", "trash_overflow.jpg", null, 0, 0, 1 },
                    { 2, new DateTime(2023, 2, 1, 0, 0, 0, 0, DateTimeKind.Local), 2, null, "Littering on the street", "littering_street.jpg", null, 0, 1, 2 },
                    { 3, new DateTime(2023, 2, 1, 0, 0, 0, 0, DateTimeKind.Local), 3, null, "Damaged garbage bin in the neighborhood", "damaged_bin.jpg", null, 0, 2, 3 },
                    { 4, new DateTime(2023, 2, 1, 0, 0, 0, 0, DateTimeKind.Local), 4, null, "Graffiti vandalism on public property", "graffiti_vandalism.jpg", null, 1, 3, 1 },
                    { 5, new DateTime(2023, 2, 1, 0, 0, 0, 0, DateTimeKind.Local), 5, null, "Overflowing trash near shopping center", "overflow_shopping_center.jpg", null, 0, 0, 2 }
                });

            migrationBuilder.InsertData(
                table: "Reservations",
                columns: new[] { "Id", "CreatedAt", "Latitude", "Longitude", "ModifiedAt", "Price", "ServiceId", "Status", "UserId" },
                values: new object[,]
                {
                    { 1, new DateTime(2023, 2, 1, 0, 0, 0, 0, DateTimeKind.Local), 43.342273m, 17.808081m, null, 20.00m, 1, 0, 1 },
                    { 2, new DateTime(2023, 2, 1, 0, 0, 0, 0, DateTimeKind.Local), 43.343596m, 17.808183m, null, 15.50m, 2, 1, 2 },
                    { 3, new DateTime(2023, 2, 1, 0, 0, 0, 0, DateTimeKind.Local), 43.341981m, 17.805755m, null, 12.75m, 3, 0, 3 },
                    { 4, new DateTime(2023, 2, 1, 0, 0, 0, 0, DateTimeKind.Local), 43.340916m, 17.808719m, null, 30.00m, 4, 1, 3 },
                    { 5, new DateTime(2023, 2, 1, 0, 0, 0, 0, DateTimeKind.Local), 43.339490m, 17.809504m, null, 25.50m, 5, 0, 2 }
                });

            migrationBuilder.InsertData(
                table: "Vehicles",
                columns: new[] { "Id", "Capacity", "Color", "CreatedAt", "LicensePlateNumber", "ManufactureYear", "ModifiedAt", "Notes", "VehicleModelId" },
                values: new object[,]
                {
                    { 1, 5000, "Red", new DateTime(2023, 2, 1, 0, 0, 0, 0, DateTimeKind.Local), "ABC123", 2020, null, "First vehicle", 1 },
                    { 2, 6000, "Blue", new DateTime(2023, 2, 1, 0, 0, 0, 0, DateTimeKind.Local), "XYZ789", 2018, null, "Second vehicle", 2 },
                    { 3, 7000, "Green", new DateTime(2023, 2, 1, 0, 0, 0, 0, DateTimeKind.Local), "DEF456", 2022, null, "Third vehicle", 4 },
                    { 4, 5500, "Yellow", new DateTime(2023, 2, 1, 0, 0, 0, 0, DateTimeKind.Local), "GHI789", 2019, null, "Fourth vehicle", 1 },
                    { 5, 6500, "Black", new DateTime(2023, 2, 1, 0, 0, 0, 0, DateTimeKind.Local), "JKL012", 2021, null, "Fifth vehicle", 3 }
                });

            migrationBuilder.InsertData(
                table: "Answers",
                columns: new[] { "Id", "Content", "CreatedAt", "IsTrue", "ModifiedAt", "QuestionId" },
                values: new object[,]
                {
                    { 1, "Collection", new DateTime(2023, 2, 1, 0, 0, 0, 0, DateTimeKind.Local), true, null, 1 },
                    { 2, "Sorting", new DateTime(2023, 2, 1, 0, 0, 0, 0, DateTimeKind.Local), false, null, 1 },
                    { 3, "Processing", new DateTime(2023, 2, 1, 0, 0, 0, 0, DateTimeKind.Local), false, null, 1 },
                    { 4, "Single-use plastic bags", new DateTime(2023, 2, 1, 0, 0, 0, 0, DateTimeKind.Local), false, null, 2 },
                    { 5, "Plastic straws", new DateTime(2023, 2, 1, 0, 0, 0, 0, DateTimeKind.Local), false, null, 2 },
                    { 6, "Using reusable bags", new DateTime(2023, 2, 1, 0, 0, 0, 0, DateTimeKind.Local), true, null, 2 },
                    { 16, "Coal", new DateTime(2023, 2, 1, 0, 0, 0, 0, DateTimeKind.Local), false, null, 6 },
                    { 17, "Solar", new DateTime(2023, 2, 1, 0, 0, 0, 0, DateTimeKind.Local), true, null, 6 },
                    { 18, "Natural Gas", new DateTime(2023, 2, 1, 0, 0, 0, 0, DateTimeKind.Local), false, null, 6 }
                });

            migrationBuilder.InsertData(
                table: "OrderDetails",
                columns: new[] { "Id", "CreatedAt", "IsDeleted", "ModifiedAt", "OrderId", "ProductId", "Quantity" },
                values: new object[,]
                {
                    { 1, new DateTime(2023, 2, 1, 0, 0, 0, 0, DateTimeKind.Local), false, null, 1, 1, 1 },
                    { 2, new DateTime(2023, 2, 1, 0, 0, 0, 0, DateTimeKind.Local), false, null, 1, 2, 2 },
                    { 3, new DateTime(2023, 2, 1, 0, 0, 0, 0, DateTimeKind.Local), false, null, 2, 3, 1 },
                    { 4, new DateTime(2023, 2, 1, 0, 0, 0, 0, DateTimeKind.Local), false, null, 3, 1, 1 },
                    { 5, new DateTime(2023, 2, 1, 0, 0, 0, 0, DateTimeKind.Local), false, null, 3, 2, 1 },
                    { 6, new DateTime(2023, 2, 1, 0, 0, 0, 0, DateTimeKind.Local), false, null, 4, 3, 1 },
                    { 7, new DateTime(2023, 2, 1, 0, 0, 0, 0, DateTimeKind.Local), false, null, 5, 1, 2 },
                    { 8, new DateTime(2023, 2, 1, 0, 0, 0, 0, DateTimeKind.Local), false, null, 5, 2, 1 }
                });

            migrationBuilder.InsertData(
                table: "Schedules",
                columns: new[] { "Id", "CreatedAt", "IsDeleted", "ModifiedAt", "PickupDate", "Status", "VehicleId" },
                values: new object[,]
                {
                    { 4, new DateTime(2023, 2, 1, 0, 0, 0, 0, DateTimeKind.Local), false, null, new DateTime(2023, 11, 23, 21, 33, 8, 474, DateTimeKind.Local).AddTicks(39), 1, 1 },
                    { 5, new DateTime(2023, 2, 1, 0, 0, 0, 0, DateTimeKind.Local), false, null, new DateTime(2023, 11, 24, 21, 33, 8, 474, DateTimeKind.Local).AddTicks(140), 1, 2 }
                });

            migrationBuilder.InsertData(
                table: "ScheduleDrivers",
                columns: new[] { "Id", "CreatedAt", "DriverId", "IsDeleted", "ModifiedAt", "ScheduleId" },
                values: new object[,]
                {
                    { 6, new DateTime(2023, 2, 1, 0, 0, 0, 0, DateTimeKind.Local), 3, false, null, 4 },
                    { 9, new DateTime(2023, 2, 1, 0, 0, 0, 0, DateTimeKind.Local), 2, false, null, 5 }
                });

            migrationBuilder.InsertData(
                table: "ScheduleGarbages",
                columns: new[] { "Id", "CreatedAt", "GarbageId", "IsDeleted", "ModifiedAt", "ScheduleId" },
                values: new object[,]
                {
                    { 7, new DateTime(2023, 2, 1, 0, 0, 0, 0, DateTimeKind.Local), 1, false, null, 4 },
                    { 8, new DateTime(2023, 2, 1, 0, 0, 0, 0, DateTimeKind.Local), 2, false, null, 4 },
                    { 10, new DateTime(2023, 2, 1, 0, 0, 0, 0, DateTimeKind.Local), 3, false, null, 5 },
                    { 11, new DateTime(2023, 2, 1, 0, 0, 0, 0, DateTimeKind.Local), 4, false, null, 5 }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ScheduleDrivers_ScheduleId",
                table: "ScheduleDrivers",
                column: "ScheduleId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ScheduleGarbages_ScheduleId",
                table: "ScheduleGarbages",
                column: "ScheduleId");
