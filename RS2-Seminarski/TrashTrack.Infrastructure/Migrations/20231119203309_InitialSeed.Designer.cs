...
namespace TrashTrack.Infrastructure.Migrations
{
    ...
    [Migration("20231119203309_InitialSeed")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TrashTrack.Core.NotificationRabbit", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TrashTrack.Core.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2023, 2, 1, 0, 0, 0, 0, DateTimeKind.Local),
                            IsDeleted = false,
                            OrderDate = new DateTime(2023, 11, 19, 21, 33, 8, 474, DateTimeKind.Local).AddTicks(505),
                            OrderNumber = "ORD1001",
                            Total = 65.50m,
                            UserId = 1,
                            isCanceled = false
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2023, 2, 1, 0, 0, 0, 0, DateTimeKind.Local),
                            IsDeleted = false,
                            OrderDate = new DateTime(2023, 11, 17, 21, 33, 8, 474, DateTimeKind.Local).AddTicks(520),
                            OrderNumber = "ORD1002",
                            Total = 15.00m,
                            UserId = 2,
                            isCanceled = false
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2023, 2, 1, 0, 0, 0, 0, DateTimeKind.Local),
                            IsDeleted = false,
                            OrderDate = new DateTime(2023, 11, 14, 21, 33, 8, 474, DateTimeKind.Local).AddTicks(527),
                            OrderNumber = "ORD1003",
                            Total = 40.25m,
                            UserId = 3,
                            isCanceled = false
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2023, 2, 1, 0, 0, 0, 0, DateTimeKind.Local),
                            IsDeleted = false,
                            OrderDate = new DateTime(2023, 11, 12, 21, 33, 8, 474, DateTimeKind.Local).AddTicks(535),
                            OrderNumber = "ORD1004",
                            Total = 20.50m,
                            UserId = 1,
                            isCanceled = false
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2023, 2, 1, 0, 0, 0, 0, DateTimeKind.Local),
                            IsDeleted = false,
                            OrderDate = new DateTime(2023, 11, 9, 21, 33, 8, 474, DateTimeKind.Local).AddTicks(551),
                            OrderNumber = "ORD1005",
                            Total = 35.75m,
                            UserId = 2,
                            isCanceled = false
            ...
            modelBuilder.Entity("TrashTrack.Core.OrderDetails", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TrashTrack.Core.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TrashTrack.Core.Report", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            Photo = "overflow_shopping_center.jpg",
                            ReportState = 0,
                            ReportType = 0,
                            ReporterUserId = 2
                        });
            ...
            modelBuilder.Entity("TrashTrack.Core.Schedule", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2023, 2, 1, 0, 0, 0, 0, DateTimeKind.Local),
                            IsDeleted = false,
                            PickupDate = new DateTime(2023, 11, 23, 21, 33, 8, 474, DateTimeKind.Local).AddTicks(39),
                            Status = 1,
                            VehicleId = 1
                        },
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2023, 2, 1, 0, 0, 0, 0, DateTimeKind.Local),
                            IsDeleted = false,
                            PickupDate = new DateTime(2023, 11, 24, 21, 33, 8, 474, DateTimeKind.Local).AddTicks(140),
                            Status = 1,
                            VehicleId = 2
                        });
                });
            ...
            modelBuilder.Entity("TrashTrack.Core.OrderDetails", b =>
                {
                    b.HasOne("TrashTrack.Core.Order", "Order")
                        .WithMany("OrderDetails")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TrashTrack.Core.Product", "Product")
                        .WithMany("OrderDetails")
